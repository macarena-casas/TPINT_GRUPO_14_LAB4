...
<body>
	<header class="text-secondary sticky-top w-100 bg-light shadow">
		<div
			...
			<nav
				class="flex-lg-grow-1 d-flex flex-wrap align-items-center text-base ml-md-auto">
				...
				<div
					...
					<div class="py-1">
						...
						<a href="ServletAdminCliente?btnAgregarCliente"
							...
							href="ServletAdminPrestamos?btnPrestamos"
				...
				<div
					...
					<div class="py-1">
						...
						<a href="ServletCliente?btnCuentas"
							...
							href="ServletAdminPrestamos?btnSolicitarPrestamos"
							class="dropdown-item text-dark">Solicitar Préstamo</a> <a
							href="ServletPagoPrestamos?btnPagoDePrestamos"
