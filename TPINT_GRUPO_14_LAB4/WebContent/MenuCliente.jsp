                    ...
                    <div class="menu-container w-100 md:w-50 lg:w-33">
                        ...
                        <div class="button-container space-y-4">
                            ...
                            <form action="ServletAdminPrestamos" method="get">
                                <div class="mb-3">
                                    <button type="submit" name="btnSolicitarPrestamos" value="true" class="btn btn-success btn-lg btn-block">Solicitar préstamo</button>
                                </div>
                            </form>
                            <form action="ServletPagoPrestamos" method="get">
                                <div class="mb-3">
                                    <button type="submit" name="btnPagoDePrestamos" value="true" class="btn btn-success btn-lg btn-block">Pago de préstamos</button>
                                </div>
                            </form>
                        </div>
                    </div>
